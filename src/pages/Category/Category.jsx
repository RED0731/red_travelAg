    ...
    <>
      <div className="w-full h-auto flex items-center justify-center flex-col py-16 px-20">
        ...
        <div className="w-full h-auto flex items-center justify-center gap-12">
          <div className="w-[170px] h-auto flex items-center justify-center flex-col text-center bg-white p-5 border border-gray-300 rounded-lg cursor-pointer shadow-md hover:shadow-lg ease-out duration-500">
