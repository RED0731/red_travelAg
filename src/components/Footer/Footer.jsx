...
const Footer = () => {
  ...
  const FeaturedTours = [
    {
      imgUrl:
        "https://cdn.pixabay.com/photo/2021/08/04/14/16/tower-6521842_640.jpg",
      title: "Exclusive Paris city tour",
      price: "$115.23",
    },
    {
      imgUrl:
      ...
      <div className="w-full h-auto py-16 lg:px-20 md:px-16 sm:px-8 px-4 bg-gray-200/30 flex items-start gap-x-5 gap-y-8 flex-wrap">
          ...
          <div className="w-full h-auto mb-8">
            <div className="w-full h-auto text-gray-700 flex items-center gap-x-1.5 mb-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-geo-fill text-orange-600"
                viewBox="0 0 16 16"
              >
                <path
                  // fill-rule="evenodd"
              ...
              <p className="text-base text-gray-700 font-normal hover:text-orange-600 cursor-pointer ease-out duration-700">
                1234 Street Name, City Name, Postal Code
              </p>
            </div>
            <div className="w-full h-auto text-gray-700 flex items-center gap-x-1.5 mb-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-telephone-fill text-orange-600"
                viewBox="0 0 16 16"
              >
                <path
                  // fill-rule="evenodd"
            ...
            <div className="w-full h-auto text-gray-700 flex items-center gap-x-1.5 mb-2">
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-envelope-open-fill text-orange-600"
                viewBox="0 0 16 16"
              >
          ...
          <div className="w-full h-auto flex items-center gap-4">
            <Link className="text-2xl p-1.5 rounded-md bg-gray-400/70 hover:bg-orange-400/70 ease-out duration-700">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-facebook text-gray-900"
                viewBox="0 0 16 16"
              >
            ...
            <Link className="text-2xl p-1.5 rounded-md bg-gray-400/70 hover:bg-orange-400/70 ease-out duration-700">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-instagram text-gray-900"
                viewBox="0 0 16 16"
              >
            ...
            <Link className="text-2xl p-1.5 rounded-md bg-gray-400/70 hover:bg-orange-400/70 ease-out duration-700">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-youtube text-gray-900"
                viewBox="0 0 16 16"
              >
            ...
            <Link className="text-2xl p-1.5 rounded-md bg-gray-400/70 hover:bg-orange-400/70 ease-out duration-700">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-twitter-x text-gray-900"
                viewBox="0 0 16 16"
              >
        ...
        <div className="lg:w-[25%] md:w-[70%] sm:w-full w-full h-auto">
          ...
          {FeaturedTours.map((item, index) => (
            <div
              key={index}
              className="w-full h-auto flex items-center gap-x-2.5 mb-4"
            >
              <img
                src={item.imgUrl}
                alt=""
